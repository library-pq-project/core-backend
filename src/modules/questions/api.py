...
async def bulk_import_questions_upload(
    ...
    default_academic_session_id: int | None = Form(default=None),
    default_semester_id: int | None = Form(default=None),
    default_assessment_type: str | None = Form(default=None),
    default_question_format: str | None = Form(default=None),
    default_duration_minutes: int = Form(default=60),
